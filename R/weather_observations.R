...
#'
obs_weather_daily <- function(starttime,
                              endtime,
                              fmisid = NULL,
                              place = NULL,
                              ...) {
...
#' @export
#'
obs_weather_hourly <- function(starttime,
                               endtime,
                               fmisid = NULL,
                               place = NULL,
                               ...) {
...
#' @export
#'
obs_weather_monthly <- function(starttime,
                                endtime,
                                fmisid = NULL,
                                place = NULL,
                                ...) {
...
#' @seealso \link[fmi2]{list_parameters}
#'
obs_soil_hourly <- function(starttime,
                            endtime,
                            fmisid = NULL,
                            place = NULL,
                            ...) {
  fmi_obs_simple("fmi::observations::soil::hourly::simple",
                 starttime = starttime,
                 endtime = endtime,
                 fmisid = fmisid,
                 place = place,
...
#' @seealso \link[fmi2]{list_parameters}
#'
obs_sunrad_minute <- function(starttime,
                              endtime,
                              fmisid = NULL,
                              place = NULL,
                              ...) {
